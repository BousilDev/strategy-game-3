        ...
        while (build_size--) {
            ...
            for (size_t i = 0; i < constants::buildingTypeNames.size(); i++) {
                if (building_type == constants::buildingTypeNames[i]) {
                    std::shared_ptr<buildings::Building> building = buildings::Building::CreateEmpty(static_cast<buildings::BuildingType>(i));
        ...
        while (unitSize--) {
            ...
            for (size_t i = 0; i < constants::unitTypeNames.size(); i++) {
                if (unit_type == constants::unitTypeNames[i]) {
                    std::shared_ptr<units::Unit> unit = units::Unit::CreateEmpty(static_cast<units::UnitType>(i));
